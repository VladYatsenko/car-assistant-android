...
public class SpeedLimitClassifier {
    ...
    public static String MODEL_FILENAME = "classifier.tflite";

    private static final int INPUT_IMG_SIZE_WIDTH = 128;
    private static final int INPUT_IMG_SIZE_HEIGHT = 128;
